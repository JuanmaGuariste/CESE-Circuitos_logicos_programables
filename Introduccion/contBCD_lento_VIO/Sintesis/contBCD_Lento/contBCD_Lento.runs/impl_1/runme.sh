...
HD_PWD='C:/Users/Juanma/Documents/CESE/CLP/TPs_CLP/Introduccion/contBCD_lento_VIO/Sintesis/contBCD_Lento/contBCD_Lento.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log contBCD_Lento_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source contBCD_Lento_VIO.tcl -notrace
