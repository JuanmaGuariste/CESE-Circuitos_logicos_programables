...
HD_PWD='C:/Users/Juanma/Documents/CESE/CLP/TPs_CLP/Introduccion/contBCD_lento_VIO/Sintesis/contBCD_Lento/contBCD_Lento.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log contBCD_Lento_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source contBCD_Lento_VIO.tcl
