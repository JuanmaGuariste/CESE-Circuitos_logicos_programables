...
HD_PWD='C:/Users/Juanma/Documents/CESE/CLP/TPs_CLP/TP_Final/FIR_Filter_VIO/Sintesis/FIR_Filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Filter_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_Filter_VIO.tcl -notrace
