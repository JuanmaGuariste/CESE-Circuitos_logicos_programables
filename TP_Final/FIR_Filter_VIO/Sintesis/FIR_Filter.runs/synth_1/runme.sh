...
HD_PWD='C:/Users/Juanma/Documents/CESE/CLP/TPs_CLP/TP_Final/FIR_Filter_VIO/Sintesis/FIR_Filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_Filter_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_Filter_VIO.tcl
